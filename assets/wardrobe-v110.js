(()=>{
  ...
  const standard=()=>{
    ...
    return `<div class="v110Wardrobe ${panelOpen?'v110DrawerOpen':''}"><div class="v110Stage v110OriginalUI">${stage}${side()}<aside class="v110Panel" aria-label="${labels[active]}素材選擇">${panel}</aside></div></div>`;
  };
