(()=>{
  ...
  fixedLayerStyle.textContent='#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110LayerBase{position:absolute!important;inset:0!important;z-index:1!important;width:100%!important;height:100%!important;object-fit:fill!important;object-position:center center!important}#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110WearLayer{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;display:block!important;object-fit:fill!important;object-position:center center!important;pointer-events:none!important;transform:none!important;transform-origin:center!important;filter:none!important}#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110BottomSkin{z-index:4!important;clip-path:none!important;-webkit-mask-image:radial-gradient(ellipse 16% 5% at 64% 49%,#000 42%,transparent 76%)!important;mask-image:radial-gradient(ellipse 16% 5% at 64% 49%,#000 42%,transparent 76%)!important}#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110WearShoes{z-index:5!important;clip-path:inset(67% 0 0 0)!important;-webkit-mask-image:none!important;mask-image:none!important}#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110WearBottom{z-index:6!important;clip-path:none!important;-webkit-mask-image:none!important;mask-image:none!important}#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110WearBag{z-index:7!important}#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110WearAccessory{z-index:8!important}#wardrobe .v110Stage.v110OriginalUI .v110LayeredStage .v110WearLayer[hidden]{display:none!important}';
  ...
  const stageLayerUrl=kind=>{
    if(verifiedMixScene()&&['bottomSkin','bottom','shoes'].includes(kind))return '';
    if(kind==='bottomSkin'){
      const scene=draft.bottom?(fittedBottomScenes[draft.bottom]||''):'';
      return scene?`${scene}&fit=20260920-71`:'';
    }
  ...
  const optionalLayerHtml=kind=>{
    ...
    return `<img class="v110WearLayer ${className}" data-v110-layer="${kind}" src="${url}" alt="${kind==='bottomSkin'?'下身融合區':labels[kind]}" ${url?'':'hidden'}>`;
  };
  const layerOrder=['bottomSkin','shoes','bottom','bag','accessory'];
