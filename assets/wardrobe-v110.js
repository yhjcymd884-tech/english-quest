(()=>{
  ...
  const blazerBottomScenes={
    pinkSkirt:'assets/mix-lab/top-blazer-bottom-pinkSkirt-fused-v1.webp?v=blazerbottoms-v1',
    navySkirt:'assets/mix-lab/top-blazer-bottom-navySkirt-fused-v1.webp?v=blazerbottoms-v1',
    latteSkirt:'assets/mix-lab/top-blazer-bottom-latteSkirt-fused-v1.webp?v=blazerbottoms-v1',
    denimShort:'assets/mix-lab/top-blazer-bottom-denimShort-fused-v1.webp?v=blazerbottoms-v1',
    creamLong:'assets/mix-lab/top-blazer-bottom-creamLong-fused-v1.webp?v=blazerbottoms-v1',
    blackSkirt:'assets/mix-lab/top-blazer-bottom-blackSkirt-fused-v1.webp?v=blazerbottoms-v1',
    mintSkirt:'assets/mix-lab/top-blazer-bottom-mintSkirt-fused-v1.webp?v=blazerbottoms-v1',
    redSkirt:'assets/mix-lab/top-blazer-bottom-redSkirt-fused-v1.webp?v=blazerbottoms-v1'
  };
  const hoodieBottomScenes={
    pinkSkirt:'assets/mix-lab/top-hoodie-bottom-pinkSkirt-fused-v1.webp?v=hoodiebottoms-v1',
    navySkirt:'assets/mix-lab/top-hoodie-bottom-navySkirt-fused-v1.webp?v=hoodiebottoms-v1',
    latteSkirt:'assets/mix-lab/top-hoodie-bottom-latteSkirt-fused-v1.webp?v=hoodiebottoms-v1',
    denimShort:'assets/mix-lab/top-hoodie-bottom-denimShort-fused-v1.webp?v=hoodiebottoms-v1',
    creamLong:'assets/mix-lab/top-hoodie-bottom-creamLong-fused-v1.webp?v=hoodiebottoms-v1',
    blackSkirt:'assets/mix-lab/top-hoodie-bottom-blackSkirt-fused-v1.webp?v=hoodiebottoms-v1',
    mintSkirt:'assets/mix-lab/top-hoodie-bottom-mintSkirt-fused-v1.webp?v=hoodiebottoms-v1',
    redSkirt:'assets/mix-lab/top-hoodie-bottom-redSkirt-fused-v1.webp?v=hoodiebottoms-v1'
  };
  const mintBottomScenes={
    pinkSkirt:'assets/mix-lab/top-mint-bottom-pinkSkirt-fused-v1.webp?v=mintbottoms-v1',
    navySkirt:'assets/mix-lab/top-mint-bottom-navySkirt-fused-v1.webp?v=mintbottoms-v1',
    latteSkirt:'assets/mix-lab/top-mint-bottom-latteSkirt-fused-v1.webp?v=mintbottoms-v1',
    denimShort:'assets/mix-lab/top-mint-bottom-denimShort-fused-v1.webp?v=mintbottoms-v1',
    creamLong:'assets/mix-lab/top-mint-bottom-creamLong-fused-v1.webp?v=mintbottoms-v1',
    blackSkirt:'assets/mix-lab/top-mint-bottom-blackSkirt-fused-v1.webp?v=mintbottoms-v1',
    mintSkirt:'assets/mix-lab/top-mint-bottom-mintSkirt-fused-v1.webp?v=mintbottoms-v1',
    redSkirt:'assets/mix-lab/top-mint-bottom-redSkirt-fused-v1.webp?v=mintbottoms-v1'
  };
  const blackBottomScenes={
    pinkSkirt:'assets/mix-lab/top-black-bottom-pinkSkirt-fused-v1.webp?v=blackbottoms-v1',
    navySkirt:'assets/mix-lab/top-black-bottom-navySkirt-fused-v1.webp?v=blackbottoms-v1',
    latteSkirt:'assets/mix-lab/top-black-bottom-latteSkirt-fused-v1.webp?v=blackbottoms-v1',
    denimShort:'assets/mix-lab/top-black-bottom-denimShort-fused-v1.webp?v=blackbottoms-v1',
    creamLong:'assets/mix-lab/top-black-bottom-creamLong-fused-v1.webp?v=blackbottoms-v1',
    blackSkirt:'assets/mix-lab/top-black-bottom-blackSkirt-fused-v1.webp?v=blackbottoms-v1',
    mintSkirt:'assets/mix-lab/top-black-bottom-mintSkirt-fused-v1.webp?v=blackbottoms-v1',
    redSkirt:'assets/mix-lab/top-black-bottom-redSkirt-fused-v1.webp?v=blackbottoms-v1'
  };
  const verifiedMixScene=()=>{
    ...
    if(draft.top==='blazer'&&!draft.shoes&&!draft.bag&&!draft.accessory){
      return blazerBottomScenes[draft.bottom]||'';
    }
    if(draft.top==='hoodie'&&!draft.shoes&&!draft.bag&&!draft.accessory){
      return hoodieBottomScenes[draft.bottom]||'';
    }
    if(draft.top==='mint'&&!draft.shoes&&!draft.bag&&!draft.accessory){
      return mintBottomScenes[draft.bottom]||'';
    }
    if(draft.top==='black'&&!draft.shoes&&!draft.bag&&!draft.accessory){
      return blackBottomScenes[draft.bottom]||'';
    }
